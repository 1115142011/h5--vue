  ...
  <div class="maintain">
    ...
    <div class="eachPanel">
      ...
      <div class="centerInfo">
        <span class="leftRow bg1 ft10">待评价</span>
        <div class="rightRow">
    ...
    <div class="content">
      ...
      <div v-if="orderInfo.status">
        <div class="eachRow mt10">
          <span class="ft15 leftPart bold">责任方</span>
          <span class="ft14 rightPart">{{orderInfo.dutyTypeName}}</span>
        </div>
        <div class="eachRow">
          <span class="ft15 leftPart bold">变更原因</span>
          <span class="ft14 rightPart">租客拒修</span>
        </div>
        <div class="eachRow">
