    ...
    <div class="maintain">
        ...
        <div class="content">
            ...
            <div class="eachRow">
                ...
                <span class="ft14">退回工单</span>
            </div>
            <div class="eachRow">
                <span class="ft15 bold">最新备注</span>
                <span class="ft14">{{orderInfo.backDesc}}</span>
            </div>
            <div class="eachRow">
                <span class="ft15 bold">退回照片</span>
                <span class="ft14"></span>
            </div>
            <div class="imgContainer">
                <div class="eachImg" v-for="(item,index) in orderInfo.backFile" :key="index">
                    <img v-image-preview class="img" :src="item.visitPath">
                </div>
            </div>
            <div class="border"></div>
